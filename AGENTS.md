...
3. Run:
   npm run lint
   npm run build
4. If checks fail, do not commit or push.
5. Review:
   git diff
   git status
6. Commit with a descriptive message.
7. Push to the GitHub production branch.
8. Verify the remote commit exists.
9. Check whether Railway started a deployment from that commit.
10. Do not claim the update is live until the public domain reflects it.
