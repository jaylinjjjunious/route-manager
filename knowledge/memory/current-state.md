...
- **Job system:** 5 types, legacy statuses, completion workflow, proof vault, and optional v1 lifecycle state normalized at load/storage while `JobStatus` remains authoritative.
...
**Last Updated:** 2026-08-15 (Job storage schema v5 adds optional lifecycle overlay with legacy-safe normalization)
