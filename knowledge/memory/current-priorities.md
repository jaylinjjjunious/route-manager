...
- Complete Smart Aisle Scan real-iPhone verification through `/real-device-verification?access=smart-aisle-iphone`: run Safari portrait/landscape and installed Home Screen PWA tests, collect the privacy-safe report plus screenshots or recording, and evaluate any failures before marking the feature fully verified.
