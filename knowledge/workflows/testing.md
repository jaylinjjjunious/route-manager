...
- Job lifecycle storage: `tests/jobState.test.ts` validates backward-compatible lifecycle defaults for legacy jobs, preservation of existing lifecycle state, idempotent normalization, and completed legacy job mapping.
...
**Last Updated:** 2026-08-15 (Job lifecycle storage normalization tests)
